    ...
    >
        ...
        <x-slot name="form">
            ...
            <div class="sm:w-1/2 px-3 mb-6">
                <input type="text" name="title" placeholder="{{ __('title') }}" class="border-2 rounded px-3 py-1 w-full focus:border-indigo-400 input" value="{{$post->title ?? ''}}">
            </div>
            <div class="sm:w-1/2 px-3 mb-6">
                <input type="text" name="slug" placeholder="{{ __('slug') }}" class="border-2 rounded px-3 py-1 w-full focus:border-indigo-400 input" value="{{$post->slug ?? ''}}">
            </div>
            <div class="sm:w-1/2 px-3 mb-6">
                <input type="text" name="excerpt" placeholder="{{ __('excerpt') }}" class="border-2 rounded px-3 py-1 w-full focus:border-indigo-400 input" value="{{$post->excerpt ?? ''}}">
            </div>
            <div class="sm:w-1/2 px-3 mb-6">
                <input type="text" name="body" placeholder="{{ __('body') }}" class="border-2 rounded px-3 py-1 w-full focus:border-indigo-400 input" value="{{$post->body ?? ''}}">
            </div>
