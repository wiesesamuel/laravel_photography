<x-layout>
    ...
    <div class="py-4 md:py-8">
        <div class="container mx-auto px-4">
            ...
            <div class="pricing-plans lg:flex lg:-mx-4 mt-6">
                @foreach($prices as $key => $value)
                    @if (is_int($key))
                        <div class="pricing-plan-wrap lg:w-1/3 my-4 md:my-6 ">
                            <div
                                class="pricing-plan border-t-4 border-b-4 border-solid border-indigo-300 text-center max-w-sm mx-auto hover:border-indigo-600 transition-colors duration-300 rounded-lg lg:rounded-l-lg">
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="mt-6 py-4">
                                            <a href="{{route('contact') . (isset($value["msg"]) ?    ('?' . http_build_query(['msg' => $value["msg"]]))    : ''    )}}"
